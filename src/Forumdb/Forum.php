...
class Forum extends \Weleoka\Forumdb\ForumdbModel
{
    ...
    /**
     * Reset the users session TTL.
     * The default timeout is dictaded by class: User.
     *
    ...
    public function sidebarGen($tag = null)
    {
        ...
        if ($this->userIsAuthenticated()) {
            ...
            $sidebar = '
                ...
                <a href="'
                . $url . '/users/login"> Logga in</a> för att skriva inlägg';
        }
        $sidebar .= '
                <p>Forum kategorier:</p>
                <p>
                    <i class="fa fa-list-ol"></i>
                    <a href="' . $url . '/forumdb/view"> Alla</a>
                </p>';
